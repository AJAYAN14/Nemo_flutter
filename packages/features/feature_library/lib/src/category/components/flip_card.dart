...
class _FlipCardState extends State<FlipCard> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    super.initState();
    // 1:1 Kotlin Spring: stiffness=200f, dampingRatio=0.6f
  ...
  void _runSpringAnimation(bool forward) {
    // Kotlin: stiffness=200f, dampingRatio=0.6f 
    // Flutter: damping = dampingRatio * 2 * sqrt(stiffness)
    // 0.6 * 2 * sqrt(200) ≈ 17.0
  ...
  Widget build(BuildContext context) {
    return AnimatedBuilder(
      ...
      builder: (context, child) {
        // Kotlin: rotationY = if (isFrontVisible) rotation else rotation - 180f
        ...
        return Transform(
          ...
          child: Container(
            ...
            child: Container(
              ...
              child: Stack(
                children: [
                  // 1dp Border Gradient Simulation (Kotlin: .border(1.dp, Brush.verticalGradient(...)))
                  Positioned.fill(
                    child: Container(
                      decoration: BoxDecoration(
                        borderRadius: BorderRadius.circular(32),
...
class _SpeakButtonState extends State<_SpeakButton> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    ...
    // dampingRatio = 0.4f, stiffness = 400f
